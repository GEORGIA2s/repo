...
class Descending implements Comparator<Student> {
	...
	public int compare(Student st1, Student st2) {
		...
		if (result == 0)
			result = st2.getSt_no().compareTo(st1.getSt_no());
...
class Student implements Comparable<Student> {
	...
	public Student(String st_no, String name, int kor, int eng, int math) {
		this.st_no = st_no;
		this.name = name;
		this.kor = kor;
		this.eng = eng;
	...
	public String toString() {
		return "Student{" + "st_no=" + st_no + ", name='" + name + '\'' + ", kor=" + kor + ", eng=" + eng + ", math="
				+ math + ", sum=" + sum + ", grade=" + grade + '}';
	}
	...
	public int compareTo(Student st) {
		return this.getSt_no().compareTo(st.getSt_no());
//		return Integer.compare(this.getSt_no(), st.getSt_no());
//		return new Integer(this.getSt_no()).compareTo(st.getSt_no());
	}
}